...
@SuppressLint("InflateParams") public class DetailFavourite extends BaseAdapter{
	...
	public View getView(int arg0, View arg1, ViewGroup arg2) {
		...
		if (arg1 == null) {
			...
			arg1 = layoutInflater.inflate(R.layout.detaillistfavourite, null);
			mHolder = new Holder();
	...
	public DetailFavourite(Context c,ArrayList<String> id,ArrayList<String> name,ArrayList<String> lyric,ArrayList<String> author) {
		this.mContext = c;
		this.id = id;
		this.name = name;
		this.lyric = lyric;
